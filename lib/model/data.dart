import 'package:signup_login/model/product.dart';
...
class AppData {
  static List<Product> productList = [
    Product(
        ...
        category: "Shri Agarwal(E20CSE480)"),
    Product(
        id: 2,
        ...
        category: "Sakshi Saxena(E20CSE513)"),
    Product(
        id: 3,
        name: 'Crop Top',
        price: 50.00,
        isliked: false,
        image: 'assets/croptop.png',
        category: "Drishti Rai (E20CSE495)"),
  ];
  ...
  static List<Category> categoryList = [
    ...
    Category(id: 4, name: "Dress", image: 'assets/dress.png'),
  ];
