        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                _icon(Icons.shopping_bag_outlined, _selectedIndex == 0, 0),
                _icon(Icons.delivery_dining_outlined, _selectedIndex == 1, 1),
                _icon(Icons.history, _selectedIndex == 2, 2),
                _icon(Icons.supervised_user_circle, _selectedIndex == 3, 3),
              ],
            ),
          ),
        ],
